...
/**
 * The top N populated cities in the wortld where N is provided by the user and you pick the continent
 */
...
public class Report_4 {
    public static void main(String[] args) {
        ...
        if (con != null) {
            try {
                // Get number of top cities (N) from user input
                Scanner scanner = new Scanner(System.in);
                System.out.print("Enter the number of top cities you want to retrieve: ");
                int topN = scanner.nextInt();

                // SQL query to fetch top N cities based on population
                String query = "SELECT " +
                ...
                pstmt.setInt(1, topN);  // Set top N parameter
